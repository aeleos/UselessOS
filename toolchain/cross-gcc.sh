...
echo "Building GCC for native installation targetting $TARGET, installed into $USELESS_SYSROOT$VIRTPREFIX"
...
pushd build || bail
    ...
    pushd gcc-native || bail
        ...
        touch $USELESS_SYSROOT/usr/include/fenv.h
